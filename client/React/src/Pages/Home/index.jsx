    ...
    return (
        <Layout>
            <div className="flex items-center justify-center mb-4">
                <h1 className="text-3xl font-medium">{context.homeDataClient.attributes.name}</h1>
            </div>

            <div className="container mx-full bg-gray-200 p-4">
                ...
                <div className="mt-4 rounded-lg overflow-hidden shadow-lg bg-gray-100">
                    <div className="p-4">
